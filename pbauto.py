...
class PbAuto:
    ...
    def connect_tcp(ip="", domain=0):
        """Connects to Pandoras Box using the TCP protocol"""
        return PbAuto(Tcp(ip, domain))

    @staticmethod
    def offline_http(ip, callback=print):
        return PbAuto(OfflineHttp(ip, callback))

    @staticmethod
    def offline_tcp(domain=0, callback=print, data_format='hex'):
        """Creates an offline message generator for the TCP protocol"""
    ...
    Result = namedtuple('Result', 'ok code error')
    Result.__new__.__defaults__ = (0,)


    def set_device_param_int(self, site_id, device_id, parameter_name, parameter_value, do_silent, do_direct):
        b = ByteUtil()
        b.write_short(1)
        b.write_int(site_id)
    ...
    def set_device_param_double(self, site_id, device_id, parameter_name, parameter_value, do_silent, do_direct):
        b = ByteUtil()
        b.write_short(84)
        b.write_int(site_id)
        b.write_int(device_id)
    ...
    def set_device_param_byte_tuples(self, site_id, device_id, parameter_name, tuple_dimension, tuple_data, do_silent, do_direct):
        b = ByteUtil()
        b.write_short(115)
        b.write_int(site_id)
        b.write_int(device_id)
    ...
    GetParam = namedtuple('GetParam', 'ok code error parameter_value')
    ...
    def get_param(self, site_id, device_id, parameter_name):
        ...
        if not r:
            return PbAuto.Result(ok=False, code=-1, error=0)
        c = r.read_short()
        if c < 0:
            return PbAuto.Result(ok=False, code=c, error=r.read_int())
        return PbAuto.GetParam(ok=True, code=c, error=0, parameter_value=r.read_double())

    GetParamByteTuples = namedtuple('GetParamByteTuples', 'ok code error tuple_dimension tuple_data')
    ...
    def get_param_byte_tuples(self, site_id, device_id, parameter_name):
        ...
        if c < 0:
            return PbAuto.Result(ok=False, code=c, error=r.read_int())
        return PbAuto.GetParamByteTuples(ok=True, code=c, error=0, tuple_dimension=r.read_int(), tuple_data=r.read_byte_buffer())

    def set_device_param_of_kind(self, site_id, device_id, parameter_kind_id, parameter_value, do_silent, do_direct):
        b = ByteUtil()
        b.write_short(39)
        b.write_int(site_id)
        b.write_int(device_id)
    ...
    def set_device_param_of_kind_double(self, site_id, device_id, parameter_kind_id, parameter_value, do_silent, do_direct):
        b = ByteUtil()
        b.write_short(85)
        b.write_int(site_id)
        b.write_int(device_id)
    ...
    GetParamOfKind = namedtuple('GetParamOfKind', 'ok code error parameter_value')
    ...
    def get_param_of_kind(self, site_id, device_id, parameter_kind_id):
        ...
        if c < 0:
            return PbAuto.Result(ok=False, code=c, error=r.read_int())
        return PbAuto.GetParamOfKind(ok=True, code=c, error=0, parameter_value=r.read_double())

    def set_device_param_in_selection(self, parameter_name, parameter_value):
        b = ByteUtil()
        b.write_short(58)
        b.write_string_narrow(parameter_name)
        b.write_int(parameter_value)
    ...
    def set_device_param_in_selection_double(self, parameter_name, parameter_value):
        b = ByteUtil()
        b.write_short(99)
        b.write_string_narrow(parameter_name)
        b.write_double(parameter_value)
    ...
    def set_device_param_of_kind_in_selection(self, parameter_kind_id, parameter_value):
        b = ByteUtil()
        b.write_short(59)
        b.write_int(parameter_kind_id)
        b.write_int(parameter_value)
    ...
    def set_device_param_of_kind_in_selection_double(self, parameter_kind_id, parameter_value):
        b = ByteUtil()
        b.write_short(100)
        b.write_int(parameter_kind_id)
        b.write_double(parameter_value)
    ...
    def set_device_param_lerp_time(self, site_id, device_id, parameter_name, smoothing_time):
        b = ByteUtil()
        b.write_short(232)
        b.write_int(site_id)
        b.write_int(device_id)
    ...
    GetDeviceIsSelected = namedtuple('GetDeviceIsSelected', 'ok code error is_selected')

    def get_device_is_selected(self, site_id, device_id):
        b = ByteUtil()
        b.write_short(74)
        b.write_int(site_id)
        b.write_int(device_id)
        ...
        if c < 0:
            return PbAuto.Result(ok=False, code=c, error=r.read_int())
        return PbAuto.GetDeviceIsSelected(ok=True, code=c, error=0, is_selected=r.read_byte())

    GetDeviceSelectionCount = namedtuple('GetDeviceSelectionCount', 'ok code error selected_devices_count')

    def get_device_selection_count(self):
        b = ByteUtil()
        b.write_short(81)
        r = self.__c.send(b, True)
        if not r:
        ...
        if c < 0:
            return PbAuto.Result(ok=False, code=c, error=r.read_int())
        return PbAuto.GetDeviceSelectionCount(ok=True, code=c, error=0, selected_devices_count=r.read_int())

    GetDeviceInSelection = namedtuple('GetDeviceInSelection', 'ok code error site_id device_id')

    def get_device_in_selection(self, selection_index):
        b = ByteUtil()
        b.write_short(75)
        ...
        if c < 0:
            return PbAuto.Result(ok=False, code=c, error=r.read_int())
        return PbAuto.GetDeviceInSelection(ok=True, code=c, error=0, site_id=r.read_int(), device_id=r.read_int())

    def set_seq_media_at_time(self, site_id, device_id, sequence_id, hours, minutes, seconds, frames, dmx_folder_id, dmx_file_id):
        b = ByteUtil()
        b.write_short(56)
        b.write_int(site_id)
        b.write_int(device_id)
    ...
    def set_device_media(self, site_id, device_id, dmx_folder_id, dmx_file_id, for_mesh):
        b = ByteUtil()
        b.write_short(2)
        b.write_int(site_id)
        b.write_int(device_id)
    ...
    def set_device_media_by_name(self, site_id, device_id, resource_path, parameter_name, for_mesh):
        b = ByteUtil()
        b.write_short(129)
        b.write_int(site_id)
        b.write_int(device_id)
    ...
    def set_device_media_in_selection(self, dmx_folder_id, dmx_file_id, for_mesh):
        b = ByteUtil()
        b.write_short(61)
        b.write_int(dmx_folder_id)
        b.write_int(dmx_file_id)
    ...
    def move_resource_by_tree_item(self, item_id_from, item_id_to):
        b = ByteUtil()
        b.write_short(158)
    ...
    def set_seq_transport_mode(self, sequence_id, transport_mode):
        b = ByteUtil()
        b.write_short(3)
        b.write_int(sequence_id)
    ...
    GetSeqTransportMode = namedtuple('GetSeqTransportMode', 'ok code error transport_mode')

    def get_seq_transport_mode(self, sequence_id):
        b = ByteUtil()
        b.write_short(72)
        b.write_int(sequence_id)
        r = self.__c.send(b, True)
        ...
        if c < 0:
            return PbAuto.Result(ok=False, code=c, error=r.read_int())
        return PbAuto.GetSeqTransportMode(ok=True, code=c, error=0, transport_mode=r.read_int())

    def set_seq_time(self, sequence_id, hours, minutes, seconds, frames):
        b = ByteUtil()
        b.write_short(5)
        b.write_int(sequence_id)
        b.write_int(hours)
    ...
    GetSeqTime = namedtuple('GetSeqTime', 'ok code error hours minutes seconds frames')

    def get_seq_time(self, sequence_id):
        b = ByteUtil()
        b.write_short(73)
        b.write_int(sequence_id)
        r = self.__c.send(b, True)
        ...
        if c < 0:
            return PbAuto.Result(ok=False, code=c, error=r.read_int())
        return PbAuto.GetSeqTime(ok=True, code=c, error=0, hours=r.read_int(), minutes=r.read_int(), seconds=r.read_int(), frames=r.read_int())

    def set_seq_to_frame_next_prev(self, sequence_id, is_next):
        b = ByteUtil()
        b.write_short(6)
        b.write_int(sequence_id)
    ...
    def set_seq_to_cue(self, sequence_id, cue_id):
        b = ByteUtil()
        b.write_short(4)
        b.write_int(sequence_id)
        b.write_int(cue_id)
    ...
    def set_seq_to_cue_next_prev(self, sequence_id, is_next):
        b = ByteUtil()
        b.write_short(7)
        b.write_int(sequence_id)
        b.write_byte(is_next)
    ...
    def set_seq_transparency(self, sequence_id, transparency):
        b = ByteUtil()
        b.write_short(8)
        b.write_int(sequence_id)
    ...
    GetSeqTransparency = namedtuple('GetSeqTransparency', 'ok code error transparency')

    def get_seq_transparency(self, sequence_id):
        b = ByteUtil()
        b.write_short(91)
        b.write_int(sequence_id)
        r = self.__c.send(b, True)
        ...
        if c < 0:
            return PbAuto.Result(ok=False, code=c, error=r.read_int())
        return PbAuto.GetSeqTransparency(ok=True, code=c, error=0, transparency=r.read_int())

    def set_seq_smpte_mode(self, sequence_id, time_code_mode):
        b = ByteUtil()
        b.write_short(41)
        b.write_int(sequence_id)
    ...
    def set_seq_smpte_offset(self, sequence_id, hours, minutes, seconds, frames):
        b = ByteUtil()
        b.write_short(42)
        b.write_int(sequence_id)
        b.write_int(hours)
    ...
    def set_seq_smpte_time_stop_action(self, sequence_id, stop_action):
        b = ByteUtil()
        b.write_short(43)
        b.write_int(sequence_id)
    ...
    def set_site_fullscreen_toggle(self, site_id):
        b = ByteUtil()
        b.write_short(17)
        b.write_int(site_id)
        self.__c.send(b, False)
    ...
    def set_device_param_relative_in_selection(self, parameter_name, parameter_value):
        b = ByteUtil()
        b.write_short(60)
        b.write_string_narrow(parameter_name)
        b.write_int(parameter_value)
    ...
    def set_device_param_relative_in_selection_double(self, parameter_name, parameter_value):
        b = ByteUtil()
        b.write_short(101)
        b.write_string_narrow(parameter_name)
        b.write_double(parameter_value)
    ...
    def add_resource_to_path(self, file_path, site_id, dmx_folder_id, dmx_file_id, project_path):
        b = ByteUtil()
        b.write_short(87)
    ...
    def add_resource_to_tree_item(self, file_path, site_id, dmx_folder_id, dmx_file_id, tree_item_index):
        b = ByteUtil()
        b.write_short(153)
        b.write_string_narrow(file_path)
        b.write_int(site_id)
    ...
    def add_resource_from_local_node(self, file_path, dmx_folder_id, dmx_file_id):
        b = ByteUtil()
        b.write_short(63)
        b.write_string_narrow(file_path)
    ...
    def add_resource_from_local_node_to_path(self, file_path, project_path, dmx_folder_id, dmx_file_id):
        b = ByteUtil()
        b.write_short(135)
        b.write_string_narrow(file_path)
        b.write_string_narrow(project_path)
    ...
    def add_resource_from_local_node_to_tree_item(self, file_path, tree_item_index, dmx_folder_id, dmx_file_id):
        b = ByteUtil()
        b.write_short(154)
        b.write_string_narrow(file_path)
        b.write_int(tree_item_index)
    ...
    def add_resource_from_folder(self, folder_path, site_id, dmx_folder_id, dmx_file_id, project_path):
        b = ByteUtil()
        b.write_short(124)
    ...
    def add_resource_from_local_node_folder(self, folder_path, dmx_folder_id, dmx_file_id):
        b = ByteUtil()
        b.write_short(133)
        b.write_string_wide(folder_path)
        b.write_short(dmx_folder_id)
    ...
    def add_resource_from_local_node_folder_to_path(self, folder_path, project_path, dmx_folder_id, dmx_file_id):
        b = ByteUtil()
        b.write_short(134)
    ...
    def add_resource_folder_from_local_node_to_tree_item(self, folder_path, tree_item_index, dmx_folder_id, dmx_file_id):
        b = ByteUtil()
        b.write_short(155)
        b.write_string_narrow(folder_path)
        b.write_int(tree_item_index)
    ...
    def remove_resource_by_id(self, dmx_folder_id, dmx_file_id):
        b = ByteUtil()
        b.write_short(20)
        b.write_int(dmx_folder_id)
        b.write_int(dmx_file_id)
    ...
    def remove_resource_by_name(self, resource_path, all_equally_named):
        b = ByteUtil()
        b.write_short(125)
        b.write_string_wide(resource_path)
    ...
    def remove_conent_by_tree_item(self, tree_item_index):
        b = ByteUtil()
        b.write_short(156)
        b.write_int(tree_item_index)
        self.__c.send(b, False)
    ...
    def remove_resource_all(self, remove_folder):
        b = ByteUtil()
        b.write_short(126)
    ...
    def set_resource_dmx_id(self, resource_path, dmx_folder_id, dmx_file_id):
        b = ByteUtil()
        b.write_short(234)
        b.write_string_wide(resource_path)
        b.write_short(dmx_folder_id)
    ...
    def spread_resource_by_id(self, dmx_folder_id, dmx_file_id):
        b = ByteUtil()
        b.write_short(23)
        b.write_int(dmx_folder_id)
        b.write_int(dmx_file_id)
    ...
    def reload_resource_by_id(self, dmx_folder_id, dmx_file_id):
        b = ByteUtil()
        b.write_short(44)
        b.write_int(dmx_folder_id)
        b.write_int(dmx_file_id)
    ...
    def remove_resource_inconsistent(self):
        b = ByteUtil()
        b.write_short(34)
        self.__c.send(b, False)
        return PbAuto.Result(ok=True, code=0)

    def detach_asset_on_site(self, resource_path, site_id):
        b = ByteUtil()
        b.write_short(170)
        b.write_string_wide(resource_path)
        b.write_int(site_id)
    ...
    def detach_asset_on_site_by_id(self, dmx_folder_id, dmx_file_id, site_id):
        b = ByteUtil()
        b.write_short(171)
        b.write_int(dmx_folder_id)
        b.write_int(dmx_file_id)
    ...
    def detach_asset_on_site_by_tree_item(self, tree_item_index, site_id):
        b = ByteUtil()
        b.write_short(172)
        b.write_int(tree_item_index)
        b.write_int(site_id)
    ...
    def set_resource_frame_blending_by_id(self, dmx_folder_id, dmx_file_id, frame_blended):
        b = ByteUtil()
        b.write_short(27)
        b.write_int(dmx_folder_id)
        b.write_int(dmx_file_id)
    ...
    def set_resource_deinterlacing_by_id(self, dmx_folder_id, dmx_file_id, deinterlacer):
        b = ByteUtil()
        b.write_short(28)
        b.write_int(dmx_folder_id)
        b.write_int(dmx_file_id)
    ...
    def set_resource_anisotropic_filtering_by_id(self, dmx_folder_id, dmx_file_id, use_filtering):
        b = ByteUtil()
        b.write_short(29)
        b.write_int(dmx_folder_id)
        b.write_int(dmx_file_id)
    ...
    def set_resource_underscan_by_id(self, dmx_folder_id, dmx_file_id, use_underscan):
        b = ByteUtil()
        b.write_short(30)
        b.write_int(dmx_folder_id)
        b.write_int(dmx_file_id)
    ...
    def set_resource_mpeg_colour_space_by_id(self, dmx_folder_id, dmx_file_id, use_mpeg_color_space):
        b = ByteUtil()
        b.write_short(31)
        b.write_int(dmx_folder_id)
        b.write_int(dmx_file_id)
    ...
    def set_resource_alpha_channel_by_id(self, dmx_folder_id, dmx_file_id, use_alpha_channel):
        b = ByteUtil()
        b.write_short(32)
        b.write_int(dmx_folder_id)
        b.write_int(dmx_file_id)
    ...
    def set_cue_play_mode(self, sequence_id, cue_id, cue_mode):
        b = ByteUtil()
        b.write_short(53)
        b.write_int(sequence_id)
        b.write_int(cue_id)
        b.write_int(cue_mode)
        self.__c.send(b, False)
        return PbAuto.Result(ok=True, code=0)

    def set_seq_next_cue_play_mode(self, sequence_id, cue_mode):
        b = ByteUtil()
        b.write_short(54)
        b.write_int(sequence_id)
        b.write_int(cue_mode)
    ...
    def set_i_seq_ignore_next_cue(self, sequence_id, do_ignore):
        b = ByteUtil()
        b.write_short(55)
        b.write_int(sequence_id)
    ...
    def set_site_fullscreen(self, site_id, is_fullscreen):
        b = ByteUtil()
        b.write_short(64)
        b.write_int(site_id)
    ...
    def set_site_fullscreen_by_ip(self, ip_address, is_fullscreen):
        b = ByteUtil()
        b.write_short(65)
    ...
    GetClipRemainingTime = namedtuple('GetClipRemainingTime', 'ok code error hours minutes seconds frames')
    ...
    def get_clip_remaining_time(self, site_id, device_id, sequence_id):
        ...
        if c < 0:
            return PbAuto.Result(ok=False, code=c, error=r.read_int())
        return PbAuto.GetClipRemainingTime(ok=True, code=c, error=0, hours=r.read_int(), minutes=r.read_int(), seconds=r.read_int(), frames=r.read_int())

    GetSeqCueRemainingTime = namedtuple('GetSeqCueRemainingTime', 'ok code error hours minutes seconds frames')

    def get_seq_cue_remaining_time(self, sequence_id):
        b = ByteUtil()
        b.write_short(78)
        b.write_int(sequence_id)
        r = self.__c.send(b, True)
        ...
        if c < 0:
            return PbAuto.Result(ok=False, code=c, error=r.read_int())
        return PbAuto.GetSeqCueRemainingTime(ok=True, code=c, error=0, hours=r.read_int(), minutes=r.read_int(), seconds=r.read_int(), frames=r.read_int())

    GetResourceCount = namedtuple('GetResourceCount', 'ok code error media_count')
    ...
    def get_resource_count(self):
        ...
        if c < 0:
            return PbAuto.Result(ok=False, code=c, error=r.read_int())
        return PbAuto.GetResourceCount(ok=True, code=c, error=0, media_count=r.read_int())

    GetTreeItemCount = namedtuple('GetTreeItemCount', 'ok code error tree_item_count')
    ...
    def get_tree_item_count(self):
        ...
        if c < 0:
            return PbAuto.Result(ok=False, code=c, error=r.read_int())
        return PbAuto.GetTreeItemCount(ok=True, code=c, error=0, tree_item_count=r.read_int())
    ...
    def create_cue(self, sequence_id, cue_id, hours, minutes, seconds, frames, cue_name, cue_mode):
        b = ByteUtil()
        b.write_short(93)
        b.write_int(sequence_id)
        b.write_int(cue_id)
    ...
    CreateVideoLayerGetId = namedtuple('CreateVideoLayerGetId', 'ok code error layer_id')
    ...
    def create_video_layer_get_id(self, site_id, is_graphic_layer):
        ...
        if c < 0:
            return PbAuto.Result(ok=False, code=c, error=r.read_int())
        return PbAuto.CreateVideoLayerGetId(ok=True, code=c, error=0, layer_id=r.read_int())

    def remove_device(self, site_id, layer_id, is_graphic_layer):
        b = ByteUtil()
        b.write_short(97)
        b.write_int(site_id)
    ...
    GetSeqMediaByParam = namedtuple('GetSeqMediaByParam', 'ok code error dmx_folder_id dmx_file_id file_path resource_path')

    def get_seq_media_by_param(self, site_id, device_id, is_media, parameter_name):
        b = ByteUtil()
        b.write_short(105)
        b.write_int(site_id)
        b.write_int(device_id)
        ...
        if c < 0:
            return PbAuto.Result(ok=False, code=c, error=r.read_int())
        return PbAuto.GetSeqMediaByParam(ok=True, code=c, error=0, dmx_folder_id=r.read_int(), dmx_file_id=r.read_int(), file_path=r.read_string_narrow(), resource_path=r.read_string_narrow())

    GetDeviceTransportMode = namedtuple('GetDeviceTransportMode', 'ok code error transport_mode')

    def get_device_transport_mode(self, site_id, device_id):
        b = ByteUtil()
        b.write_short(108)
        b.write_int(site_id)
        b.write_int(device_id)
        ...
        if c < 0:
            return PbAuto.Result(ok=False, code=c, error=r.read_int())
        return PbAuto.GetDeviceTransportMode(ok=True, code=c, error=0, transport_mode=r.read_int())

    GetIsSiteConnected = namedtuple('GetIsSiteConnected', 'ok code error is_connected')
    ...
    def get_is_site_connected(self, site_id):
        ...
        if c < 0:
            return PbAuto.Result(ok=False, code=c, error=r.read_int())
        return PbAuto.GetIsSiteConnected(ok=True, code=c, error=0, is_connected=r.read_bool())

    def move_device_up(self, site_id, device_id):
        b = ByteUtil()
        b.write_short(111)
        b.write_int(site_id)
        b.write_int(device_id)
    ...
    def move_device_down(self, site_id, device_id):
        b = ByteUtil()
        b.write_short(112)
        b.write_int(site_id)
        b.write_int(device_id)
    ...
    def move_device_to_first_position(self, site_id, device_id):
        b = ByteUtil()
        b.write_short(113)
        b.write_int(site_id)
        b.write_int(device_id)
    ...
    def move_device_to_last_position(self, site_id, device_id):
        b = ByteUtil()
        b.write_short(114)
        b.write_int(site_id)
        b.write_int(device_id)
    ...
    GetEnableClxController = namedtuple('GetEnableClxController', 'ok code error is_enabled')
    ...
    def get_enable_clx_controller(self, for_jog_shuttle):
        ...
        if c < 0:
            return PbAuto.Result(ok=False, code=c, error=r.read_int())
        return PbAuto.GetEnableClxController(ok=True, code=c, error=0, is_enabled=r.read_bool())

    def set_seq_cue_wait_time(self, sequence_id, cue_id, hours, minutes, seconds, frames):
        b = ByteUtil()
        b.write_short(118)
        b.write_int(sequence_id)
        b.write_int(cue_id)
    ...
    def set_seq_cue_jump_target_time(self, sequence_id, cue_id, hours, minutes, seconds, frames):
        b = ByteUtil()
        b.write_short(119)
        b.write_int(sequence_id)
        b.write_int(cue_id)
    ...
    GetResourceIsConsistent = namedtuple('GetResourceIsConsistent', 'ok code error is_content_inconsistent')

    def get_resource_is_consistent(self, dmx_folder_id, dmx_file_id):
        b = ByteUtil()
        b.write_short(127)
        b.write_int(dmx_folder_id)
        b.write_int(dmx_file_id)
        ...
        if c < 0:
            return PbAuto.Result(ok=False, code=c, error=r.read_int())
        return PbAuto.GetResourceIsConsistent(ok=True, code=c, error=0, is_content_inconsistent=r.read_int())

    GetResourceIsConsistentByName = namedtuple('GetResourceIsConsistentByName', 'ok code error is_content_inconsistent')

    def get_resource_is_consistent_by_name(self, resource_path):
        b = ByteUtil()
        b.write_short(128)
        b.write_string_wide(resource_path)
        r = self.__c.send(b, True)
        ...
        if c < 0:
            return PbAuto.Result(ok=False, code=c, error=r.read_int())
        return PbAuto.GetResourceIsConsistentByName(ok=True, code=c, error=0, is_content_inconsistent=r.read_int())

    CreateSeqGetId = namedtuple('CreateSeqGetId', 'ok code error sequence_id')

    def create_seq_get_id(self):
        b = ByteUtil()
        b.write_short(130)
        r = self.__c.send(b, True)
        if not r:
        ...
        if c < 0:
            return PbAuto.Result(ok=False, code=c, error=r.read_int())
        return PbAuto.CreateSeqGetId(ok=True, code=c, error=0, sequence_id=r.read_int())

    def remove_seq(self, sequence_id):
        b = ByteUtil()
        b.write_short(131)
        b.write_int(sequence_id)
        self.__c.send(b, False)
    ...
    def set_site_fullscreen_show_cursor(self, site_id, show_cursor):
        b = ByteUtil()
        b.write_short(138)
        b.write_int(site_id)
    ...
    AddEncryptionKeyGetId = namedtuple('AddEncryptionKeyGetId', 'ok code error is_key_added')
    ...
    def add_encryption_key_get_id(self, encryption_key):
        ...
        if c < 0:
            return PbAuto.Result(ok=False, code=c, error=r.read_int())
        return PbAuto.AddEncryptionKeyGetId(ok=True, code=c, error=0, is_key_added=r.read_bool())

    AddEncryptionPolicyGetId = namedtuple('AddEncryptionPolicyGetId', 'ok code error is_key_added')
    ...
    def add_encryption_policy_get_id(self, encryption_policy):
        ...
        if c < 0:
            return PbAuto.Result(ok=False, code=c, error=r.read_int())
        return PbAuto.AddEncryptionPolicyGetId(ok=True, code=c, error=0, is_key_added=r.read_bool())
    ...
    GetThumbnailByPath = namedtuple('GetThumbnailByPath', 'ok code error thumbnail_width thumbnail_height thumbnail_data')
    ...
    def get_thumbnail_by_path(self, resource_path):
        ...
        if c < 0:
            return PbAuto.Result(ok=False, code=c, error=r.read_int())
        return PbAuto.GetThumbnailByPath(ok=True, code=c, error=0, thumbnail_width=r.read_int(), thumbnail_height=r.read_int(), thumbnail_data=r.read_byte_buffer())

    GetThumbnailByItemIndex = namedtuple('GetThumbnailByItemIndex', 'ok code error thumbnail_width thumbnail_height thumbnail_data')
    ...
    def get_thumbnail_by_item_index(self, tree_item_index):
        ...
        if c < 0:
            return PbAuto.Result(ok=False, code=c, error=r.read_int())
        return PbAuto.GetThumbnailByItemIndex(ok=True, code=c, error=0, thumbnail_width=r.read_int(), thumbnail_height=r.read_int(), thumbnail_data=r.read_byte_buffer())
    ...
    GetPlaylistSizeByDmxId = namedtuple('GetPlaylistSizeByDmxId', 'ok code error playlist_size')
    ...
    def get_playlist_size_by_dmx_id(self, playlist_dmx_folder_id, playlistdmx_file_id):
        ...
        if c < 0:
            return PbAuto.Result(ok=False, code=c, error=r.read_int())
        return PbAuto.GetPlaylistSizeByDmxId(ok=True, code=c, error=0, playlist_size=r.read_int())

    GetPlaylistSizeByPath = namedtuple('GetPlaylistSizeByPath', 'ok code error playlist_size')
    ...
    def get_playlist_size_by_path(self, playlist_path):
        ...
        if c < 0:
            return PbAuto.Result(ok=False, code=c, error=r.read_int())
        return PbAuto.GetPlaylistSizeByPath(ok=True, code=c, error=0, playlist_size=r.read_int())

    GetPlaylistSizeByItemId = namedtuple('GetPlaylistSizeByItemId', 'ok code error playlist_size')
    ...
    def get_playlist_size_by_item_id(self, playlist_item_index):
        ...
        if c < 0:
            return PbAuto.Result(ok=False, code=c, error=r.read_int())
        return PbAuto.GetPlaylistSizeByItemId(ok=True, code=c, error=0, playlist_size=r.read_int())
    ...
    GetCanvasDrawCommandsByDmxId = namedtuple('GetCanvasDrawCommandsByDmxId', 'ok code error commands')
    ...
    def get_canvas_draw_commands_by_dmx_id(self, canvas_dmx_folder_id, canvas_dmx_file_id):
        ...
        if c < 0:
            return PbAuto.Result(ok=False, code=c, error=r.read_int())
        return PbAuto.GetCanvasDrawCommandsByDmxId(ok=True, code=c, error=0, commands=r.read_string_narrow())

    GetCanvasDrawCommandsByPath = namedtuple('GetCanvasDrawCommandsByPath', 'ok code error commands')
    ...
    def get_canvas_draw_commands_by_path(self, canvas_resource_path):
        ...
        if c < 0:
            return PbAuto.Result(ok=False, code=c, error=r.read_int())
        return PbAuto.GetCanvasDrawCommandsByPath(ok=True, code=c, error=0, commands=r.read_string_narrow())

    GetCanvasDrawCommandsByItemId = namedtuple('GetCanvasDrawCommandsByItemId', 'ok code error commands')
    ...
    def get_canvas_draw_commands_by_item_id(self, canvas_item_index):
        ...
        if c < 0:
            return PbAuto.Result(ok=False, code=c, error=r.read_int())
        return PbAuto.GetCanvasDrawCommandsByItemId(ok=True, code=c, error=0, commands=r.read_string_narrow())

    GetResourceWidthByDmxId = namedtuple('GetResourceWidthByDmxId', 'ok code error width')

    def get_resource_width_by_dmx_id(self, dmx_folder_id, dmx_file_id):
        b = ByteUtil()
        b.write_short(251)
        b.write_int(dmx_folder_id)
        b.write_int(dmx_file_id)
        ...
        if c < 0:
            return PbAuto.Result(ok=False, code=c, error=r.read_int())
        return PbAuto.GetResourceWidthByDmxId(ok=True, code=c, error=0, width=r.read_int())

    GetResourceWidthByPath = namedtuple('GetResourceWidthByPath', 'ok code error width')

    def get_resource_width_by_path(self, folder_path_to_project):
        b = ByteUtil()
        b.write_short(252)
        b.write_string_narrow(folder_path_to_project)
        r = self.__c.send(b, True)
        ...
        if c < 0:
            return PbAuto.Result(ok=False, code=c, error=r.read_int())
        return PbAuto.GetResourceWidthByPath(ok=True, code=c, error=0, width=r.read_int())

    GetResourceWidthByItemId = namedtuple('GetResourceWidthByItemId', 'ok code error width')

    def get_resource_width_by_item_id(self, item_id):
        b = ByteUtil()
        b.write_short(253)
        b.write_int(item_id)
        r = self.__c.send(b, True)
        ...
        if c < 0:
            return PbAuto.Result(ok=False, code=c, error=r.read_int())
        return PbAuto.GetResourceWidthByItemId(ok=True, code=c, error=0, width=r.read_int())

    GetResourceHeightByDmxId = namedtuple('GetResourceHeightByDmxId', 'ok code error height')

    def get_resource_height_by_dmx_id(self, dmx_folder_id, dmx_file_id):
        b = ByteUtil()
        b.write_short(254)
        b.write_int(dmx_folder_id)
        b.write_int(dmx_file_id)
        ...
        if c < 0:
            return PbAuto.Result(ok=False, code=c, error=r.read_int())
        return PbAuto.GetResourceHeightByDmxId(ok=True, code=c, error=0, height=r.read_int())

    GetResourceHeightByPath = namedtuple('GetResourceHeightByPath', 'ok code error height')

    def get_resource_height_by_path(self, folder_path_to_project):
        b = ByteUtil()
        b.write_short(255)
        b.write_string_narrow(folder_path_to_project)
        r = self.__c.send(b, True)
        ...
        if c < 0:
            return PbAuto.Result(ok=False, code=c, error=r.read_int())
        return PbAuto.GetResourceHeightByPath(ok=True, code=c, error=0, height=r.read_int())

    GetResourceHeightByItemId = namedtuple('GetResourceHeightByItemId', 'ok code error height')

    def get_resource_height_by_item_id(self, item_id):
        b = ByteUtil()
        b.write_short(256)
        b.write_int(item_id)
        r = self.__c.send(b, True)
        ...
        if c < 0:
            return PbAuto.Result(ok=False, code=c, error=r.read_int())
        return PbAuto.GetResourceHeightByItemId(ok=True, code=c, error=0, height=r.read_int())

    GetProjectPathOnDisc = namedtuple('GetProjectPathOnDisc', 'ok code error commands')
    ...
    def get_project_path_on_disc(self):
        ...
        if c < 0:
            return PbAuto.Result(ok=False, code=c, error=r.read_int())
        return PbAuto.GetProjectPathOnDisc(ok=True, code=c, error=0, commands=r.read_string_narrow())
    ...
    def handle_sublayer(self, site_id, device_id, action, operation):
        b = ByteUtil()
        b.write_short(275)
        b.write_int(site_id)
        b.write_int(device_id)
        b.write_int(action)
        b.write_int(operation)
        self.__c.send(b, False)
        return PbAuto.Result(ok=True, code=0)
    ...
    GetCueName = namedtuple('GetCueName', 'ok code error cue_name')
    ...
    def get_cue_name(self, sequence_id, cue_id):
        ...
        if c < 0:
            return PbAuto.Result(ok=False, code=c, error=r.read_int())
        return PbAuto.GetCueName(ok=True, code=c, error=0, cue_name=r.read_string_narrow())
    ...
    def set_device_media_by_name(self, site_id, device_id, source_device_id, parameter_name):
        b = ByteUtil()
        b.write_short(282)
        b.write_int(site_id)
        b.write_int(device_id)
    ...
    def set_device_media_to_param(self, site_id, device_id, dmx_folder_id, dmx_file_id, for_mesh, parameter_name):
        b = ByteUtil()
        b.write_short(283)
        b.write_int(site_id)
        b.write_int(device_id)
    ...
    def add_image_seq(self, folder_path, site_id, dmx_folder_id, dmx_file_id, fps):
        b = ByteUtil()
        b.write_short(284)
        b.write_string_narrow(folder_path)
        b.write_int(site_id)
    ...
    def add_image_seq_to_folder(self, folder_path, site_id, dmx_folder_id, dmx_file_id, fps, project_path):
        b = ByteUtil()
        b.write_short(285)
        b.write_string_narrow(folder_path)
        b.write_int(site_id)
    ...
    def add_image_seq_to_tree_item(self, folder_path, site_id, dmx_folder_id, dmx_file_id, fps, tree_item_index):
        b = ByteUtil()
        b.write_short(286)
        b.write_string_narrow(folder_path)
        b.write_int(site_id)
    ...
    def add_image_seq_from_local_node(self, folder_path, fps):
        b = ByteUtil()
        b.write_short(287)
        b.write_string_narrow(folder_path)
        b.write_int(fps)
    ...
    def add_image_seq_from_local_node_id(self, folder_path, fps, dmx_folder_id, dmx_file_id):
        b = ByteUtil()
        b.write_short(288)
        b.write_string_narrow(folder_path)
        b.write_int(fps)
    ...
    def add_image_seq_from_local_node_to_folder(self, folder_path, fps, project_path):
        b = ByteUtil()
        b.write_short(289)
        b.write_string_narrow(folder_path)
        b.write_int(fps)
    ...
    def add_image_seq_from_local_node_to_folder_id(self, folder_path, fps, dmx_folder_id, dmx_file_id, project_path):
        b = ByteUtil()
        b.write_short(290)
        b.write_string_narrow(folder_path)
        b.write_int(fps)
    ...
    def add_image_seq_from_local_node_to_tree_item(self, folder_path, fps, tree_item_index):
        b = ByteUtil()
        b.write_short(291)
        b.write_string_narrow(folder_path)
        b.write_int(fps)
    ...
    def add_image_seq_from_local_node_to_tree_item_id(self, folder_path, fps, dmx_folder_id, dmx_file_id, tree_item_index):
        b = ByteUtil()
        b.write_short(292)
        b.write_string_narrow(folder_path)
        b.write_int(fps)
    ...
    GetCurrentTimeCueInfo = namedtuple('GetCurrentTimeCueInfo', 'ok code error hours minutes seconds frames previous_cue_id previous_cue_name hours_previous_cue minutes_previous_cue seconds_previous_cue frames_previous_cue previous_cue_mode next_cue_id next_cue_name hours_next_cue minutes_next_cue seconds_next_cue frames_next_cue next_cue_mode')
    ...
    def get_current_time_cue_info(self, sequence_id):
        ...
        if c < 0:
            return PbAuto.Result(ok=False, code=c, error=r.read_int())
        return PbAuto.GetCurrentTimeCueInfo(ok=True, code=c, error=0, hours=r.read_int(), minutes=r.read_int(), seconds=r.read_int(), frames=r.read_int(), previous_cue_id=r.read_int(), previous_cue_name=r.read_string_narrow(), hours_previous_cue=r.read_int(), minutes_previous_cue=r.read_int(), seconds_previous_cue=r.read_int(), frames_previous_cue=r.read_int(), previous_cue_mode=r.read_int(), next_cue_id=r.read_int(), next_cue_name=r.read_string_narrow(), hours_next_cue=r.read_int(), minutes_next_cue=r.read_int(), seconds_next_cue=r.read_int(), frames_next_cue=r.read_int(), next_cue_mode=r.read_int())

    def get_resource_is_consistent_by_tree_item(self, tree_item_index):
        b = ByteUtil()
        b.write_short(296)
        b.write_int(tree_item_index)
        self.__c.send(b, False)
    ...
    def set_seq_selection(self, sequence_id):
        b = ByteUtil()
        b.write_short(299)
        b.write_int(sequence_id)
        self.__c.send(b, False)
    ...
    GetWatchedFolderProperty = namedtuple('GetWatchedFolderProperty', 'ok code error is_enabled')
    ...
    def get_watched_folder_property(self, project_path, watch_folder_property):
        ...
        if c < 0:
            return PbAuto.Result(ok=False, code=c, error=r.read_int())
        return PbAuto.GetWatchedFolderProperty(ok=True, code=c, error=0, is_enabled=r.read_bool())

    GetWatchedFolderPropertyByItemId = namedtuple('GetWatchedFolderPropertyByItemId', 'ok code error is_enabled')
    ...
    def get_watched_folder_property_by_item_id(self, tree_item_index, watch_folder_property):
        ...
        if c < 0:
            return PbAuto.Result(ok=False, code=c, error=r.read_int())
        return PbAuto.GetWatchedFolderPropertyByItemId(ok=True, code=c, error=0, is_enabled=r.read_bool())

    GetFolderSpreadToSite = namedtuple('GetFolderSpreadToSite', 'ok code error is_enabled')
    ...
    def get_folder_spread_to_site(self, project_path, site_id):
        ...
        if c < 0:
            return PbAuto.Result(ok=False, code=c, error=r.read_int())
        return PbAuto.GetFolderSpreadToSite(ok=True, code=c, error=0, is_enabled=r.read_bool())

    GetFolderSpreadToSiteByItemId = namedtuple('GetFolderSpreadToSiteByItemId', 'ok code error is_enabled')
    ...
    def get_folder_spread_to_site_by_item_id(self, tree_item_index, site_id):
        ...
        if c < 0:
            return PbAuto.Result(ok=False, code=c, error=r.read_int())
        return PbAuto.GetFolderSpreadToSiteByItemId(ok=True, code=c, error=0, is_enabled=r.read_bool())
    ...
    def add_resource(self, file_path, site_id, dmx_folder_id, dmx_file_id, auto_increment_dmx_id):
        b = ByteUtil()
        b.write_short(19)
        b.write_string_narrow(file_path)
        b.write_int(site_id)
    ...
    GetResourceInfo = namedtuple('GetResourceInfo', 'ok code error dmx_folder_id dmx_file_id resource_name resource_path project_path width height fps hours minutes seconds frames options')

    def get_resource_info(self, tree_items_media_index):
        b = ByteUtil()
        b.write_short(76)
        ...
        if c < 0:
            return PbAuto.Result(ok=False, code=c, error=r.read_int())
        return PbAuto.GetResourceInfo(ok=True, code=c, error=0, dmx_folder_id=r.read_int(), dmx_file_id=r.read_int(), resource_name=r.read_string_narrow(), resource_path=r.read_string_narrow(), project_path=r.read_string_narrow(), width=r.read_int(), height=r.read_int(), fps=r.read_int(), hours=r.read_int(), minutes=r.read_int(), seconds=r.read_int(), frames=r.read_int(), options=r.read_int())
    ...
    GetYawPitchRoll = namedtuple('GetYawPitchRoll', 'ok code error yaw pitch roll')
    ...
    def get_yaw_pitch_roll(self, site_id, device_id, in_radians):
        ...
        if c < 0:
            return PbAuto.Result(ok=False, code=c, error=r.read_int())
        return PbAuto.GetYawPitchRoll(ok=True, code=c, error=0, yaw=r.read_double(), pitch=r.read_double(), roll=r.read_double())

    GetSiteIds = namedtuple('GetSiteIds', 'ok code error site_ids')
    ...
    def get_site_ids(self):
        ...
        if c < 0:
            return PbAuto.Result(ok=False, code=c, error=r.read_int())
        return PbAuto.GetSiteIds(ok=True, code=c, error=0, site_ids=r.read_int_buffer())
    ...
    def set_device_media_to_param_blocked(self, site_id, device_id, dmx_folder_id, dmx_file_id, for_mesh, parameter_name):
        b = ByteUtil()
        b.write_short(352)
        b.write_int(site_id)
        b.write_int(device_id)
    ...
    def set_device_media_blocked(self, site_id, device_id, dmx_folder_id, dmx_file_id, for_mesh):
        b = ByteUtil()
        b.write_short(353)
        b.write_int(site_id)
        b.write_int(device_id)
    ...
    def set_device_transport_mode(self, site_id, device_id, transport_mode):
        b = ByteUtil()
        b.write_short(359)
        b.write_int(site_id)
        b.write_int(device_id)
    ...
    def set_device_media_share_layer_texture(self, site_id, device_id, source_device_id):
        b = ByteUtil()
        b.write_short(281)
        b.write_int(site_id)
        b.write_int(device_id)
    ...
    GetHostRevisionNumber = namedtuple('GetHostRevisionNumber', 'ok code error revision')
    ...
    def get_host_revision_number(self):
        ...
        if c < 0:
            return PbAuto.Result(ok=False, code=c, error=r.read_int())
        return PbAuto.GetHostRevisionNumber(ok=True, code=c, error=0, revision=r.read_int())

    GetTreeItemInfo = namedtuple('GetTreeItemInfo', 'ok code error resource_type resource_path folder_path')
    ...
    def get_tree_item_info(self, tree_item_index):
        ...
        if c < 0:
            return PbAuto.Result(ok=False, code=c, error=r.read_int())
        return PbAuto.GetTreeItemInfo(ok=True, code=c, error=0, resource_type=r.read_int(), resource_path=r.read_string_wide(), folder_path=r.read_string_wide())

    GetResourceInfoByTreeItemIndex = namedtuple('GetResourceInfoByTreeItemIndex', 'ok code error dmx_folder_id dmx_file_id resource_name resource_path project_path width height fps hours minutes seconds frames options')

    def get_resource_info_by_tree_item_index(self, index):
        b = ByteUtil()
        b.write_short(152)
        b.write_int(index)
        r = self.__c.send(b, True)
        ...
        if c < 0:
            return PbAuto.Result(ok=False, code=c, error=r.read_int())
        return PbAuto.GetResourceInfoByTreeItemIndex(ok=True, code=c, error=0, dmx_folder_id=r.read_int(), dmx_file_id=r.read_int(), resource_name=r.read_string_narrow(), resource_path=r.read_string_narrow(), project_path=r.read_string_narrow(), width=r.read_int(), height=r.read_int(), fps=r.read_int(), hours=r.read_int(), minutes=r.read_int(), seconds=r.read_int(), frames=r.read_int(), options=r.read_int())

    GetPlaylistEntryByDmxId = namedtuple('GetPlaylistEntryByDmxId', 'ok code error tree_item_index resource_name resource_path duration_hours duration_minutes duration_seconds duration_frames fade_out_hour fade_out_minute fade_out_second fade_out_frame start_hour start_minute start_second start_frame end_hour end_minute end_second end_frame fade_fx_id')
    ...
    def get_playlist_entry_by_dmx_id(self, playlist_dmx_folder_id, playlistdmx_file_id, playlist_entry_index):
        ...
        if c < 0:
            return PbAuto.Result(ok=False, code=c, error=r.read_int())
        return PbAuto.GetPlaylistEntryByDmxId(ok=True, code=c, error=0, tree_item_index=r.read_int(), resource_name=r.read_string_narrow(), resource_path=r.read_string_narrow(), duration_hours=r.read_int(), duration_minutes=r.read_int(), duration_seconds=r.read_int(), duration_frames=r.read_int(), fade_out_hour=r.read_int(), fade_out_minute=r.read_int(), fade_out_second=r.read_int(), fade_out_frame=r.read_int(), start_hour=r.read_int(), start_minute=r.read_int(), start_second=r.read_int(), start_frame=r.read_int(), end_hour=r.read_int(), end_minute=r.read_int(), end_second=r.read_int(), end_frame=r.read_int(), fade_fx_id=r.read_int())

    GetPlaylistEntryByPath = namedtuple('GetPlaylistEntryByPath', 'ok code error tree_item_index resource_name resource_path duration_hours duration_minutes duration_seconds duration_frames fade_out_hour fade_out_minute fade_out_second fade_out_frame start_hour start_minute start_second start_frame end_hour end_minute end_second end_frame fade_fx_id')
    ...
    def get_playlist_entry_by_path(self, playlist_path, playlist_entry_index):
        ...
        if c < 0:
            return PbAuto.Result(ok=False, code=c, error=r.read_int())
        return PbAuto.GetPlaylistEntryByPath(ok=True, code=c, error=0, tree_item_index=r.read_int(), resource_name=r.read_string_narrow(), resource_path=r.read_string_narrow(), duration_hours=r.read_int(), duration_minutes=r.read_int(), duration_seconds=r.read_int(), duration_frames=r.read_int(), fade_out_hour=r.read_int(), fade_out_minute=r.read_int(), fade_out_second=r.read_int(), fade_out_frame=r.read_int(), start_hour=r.read_int(), start_minute=r.read_int(), start_second=r.read_int(), start_frame=r.read_int(), end_hour=r.read_int(), end_minute=r.read_int(), end_second=r.read_int(), end_frame=r.read_int(), fade_fx_id=r.read_int())

    GetPlaylistEntryByItemId = namedtuple('GetPlaylistEntryByItemId', 'ok code error tree_item_index resource_name resource_path duration_hours duration_minutes duration_seconds duration_frames fade_out_hour fade_out_minute fade_out_second fade_out_frame start_hour start_minute start_second start_frame end_hour end_minute end_second end_frame fade_fx_id')
    ...
    def get_playlist_entry_by_item_id(self, playlist_item_index, playlist_entry_index):
        ...
        if c < 0:
            return PbAuto.Result(ok=False, code=c, error=r.read_int())
        return PbAuto.GetPlaylistEntryByItemId(ok=True, code=c, error=0, tree_item_index=r.read_int(), resource_name=r.read_string_narrow(), resource_path=r.read_string_narrow(), duration_hours=r.read_int(), duration_minutes=r.read_int(), duration_seconds=r.read_int(), duration_frames=r.read_int(), fade_out_hour=r.read_int(), fade_out_minute=r.read_int(), fade_out_second=r.read_int(), fade_out_frame=r.read_int(), start_hour=r.read_int(), start_minute=r.read_int(), start_second=r.read_int(), start_frame=r.read_int(), end_hour=r.read_int(), end_minute=r.read_int(), end_second=r.read_int(), end_frame=r.read_int(), fade_fx_id=r.read_int())

    GetPlaylistEntryIndicesByDmxId = namedtuple('GetPlaylistEntryIndicesByDmxId', 'ok code error tree_item_ids')
    ...
    def get_playlist_entry_indices_by_dmx_id(self, playlist_dmx_folder_id, playlistdmx_file_id):
        ...
        if c < 0:
            return PbAuto.Result(ok=False, code=c, error=r.read_int())
        return PbAuto.GetPlaylistEntryIndicesByDmxId(ok=True, code=c, error=0, tree_item_ids=r.read_int_buffer())

    GetPlaylistEntryIndicesByPath = namedtuple('GetPlaylistEntryIndicesByPath', 'ok code error tree_item_ids')
    ...
    def get_playlist_entry_indices_by_path(self, playlist_path):
        ...
        if c < 0:
            return PbAuto.Result(ok=False, code=c, error=r.read_int())
        return PbAuto.GetPlaylistEntryIndicesByPath(ok=True, code=c, error=0, tree_item_ids=r.read_int_buffer())

    GetPlaylistEntryIndicesByItemId = namedtuple('GetPlaylistEntryIndicesByItemId', 'ok code error tree_item_ids')
    ...
    def get_playlist_entry_indices_by_item_id(self, playlist_item_index):
        ...
        if c < 0:
            return PbAuto.Result(ok=False, code=c, error=r.read_int())
        return PbAuto.GetPlaylistEntryIndicesByItemId(ok=True, code=c, error=0, tree_item_ids=r.read_int_buffer())

    CreateGraphicLayerGetId = namedtuple('CreateGraphicLayerGetId', 'ok code error layer_id')
    ...
    def create_graphic_layer_get_id(self, site_id, is_graphic_layer):
        ...
        if c < 0:
            return PbAuto.Result(ok=False, code=c, error=r.read_int())
        return PbAuto.CreateGraphicLayerGetId(ok=True, code=c, error=0, layer_id=r.read_int())

    def set_device_media_share_layer_texture_to_param(self, site_id, device_id, source_device_id, parameter_name):
        b = ByteUtil()
        b.write_short(282)
        b.write_int(site_id)
        b.write_int(device_id)
...
class OfflineHttp(Connector):
    ...
    def __init__(self, ip, callback=print):
        self.ip, self.callback = ip, callback
...
class OfflineTcp(Connector):
    ...
    FORMATS = {
        'hex': FormatConfig('{:02x}', ''),
        'pb': FormatConfig('{:02x}', join=' '),
        'wd': FormatConfig('[h{:02x}]'),
        'cpp': FormatConfig('0x{:02x}', pre='{', join=', ', post='}'),
    }
    ...
    def __init__(self, domain=0, callback=print, data_format='hex'):
        ...
        if isinstance(self.data_format, str):
            if self.data_format not in self.FORMATS:
                raise TypeError('%s is not valid format style')
            self.data_format = self.FORMATS[self.data_format]
        elif not isinstance(self.data_format, self.FormatConfig):
            raise TypeError("data_format has to be a FormatConfig or the name of a template")

    def format(self, data):
        return self.data_format.pre + self.data_format.join.join(self.data_format.template.format(x) for x in data) + self.data_format.post
...
class ByteUtil:
    ...
    def write_string_wide(self, val):
        self.__data.extend(struct.pack('!h', len(val)))
        self.__data.extend(struct.pack("!%is" % (len(val) * 2), val.encode("UTF-16-BE")))
    ...
    def read_int_buffer(self):
        itemCount = (len(self.__data) - self.__pos) / 4
        return [i for i in self.read_int]
